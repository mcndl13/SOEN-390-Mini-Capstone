export const polygons = [
  {
    ...
    description:
      'The MB Building is the 15-storey home of the John Molson School of Business, made up of study areas, lecture rooms and group work spaces. The John Dobson Formula Growth Investment Room gives finance students practical knowledge of the markets through financial software. The Faculty of Fine Arts’ performance spaces for theatre, contemporary dance and music are also here.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The B annex is the location of the Engineering and Computer Science Association.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The CI Annex is the location of the School of community and public affairs',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The CL Annex is the location of Concordia continuing education classrooms',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The D Annex is the location of the department of Theological Studies',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The EV Building is a two-tower research and teaching facility that brings together the Faculty of Fine Arts with the Gina Cody School of Engineering and Computer Science. The building is equipped with labs and spaces for research and creation. Our fitness facility, Le Gym, is also located here.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The FA Annex is the location of the Department of Religions and Cultures',
    boundaries: [
  ...
  },
  {
    ...
    address:
      'main entrance: 1190 Guy St, Montreal, QC H3H 2L4\n class entrance: 1175 St Mathieu St, Montreal, QC H3H 2L4',
    description:
      'Our gorgeous Grey Nuns student residence is full of character, with spacious rooms, high ceilings and lots of light. The converted chapel is an awe-inspiring Reading Room open to the whole University community. Comfortable, safe and close to class — students feel right at home on campus. Note: This space is not open for campus visitors.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The GM building is home to several administrative offices as well as: the Access Centre for Students with Disabilities, the International Students Office, Health Services, Office of Rights and Responsibilities, the Financial Aid and Awards Office.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The K Annex is where the Concordia Coop Bookstore and the Concordia University Part-Time Faculty Association are located.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The learning square has classrooms as well as hosting IT services on both the first and second floors',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The MI Annex is the location of all Employee & labour relations offices',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The R Annex is the location of the Department of Religion and Cultures',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The RR Annex is the location of the Department of the Liberal Arts College',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The Samuel Bronfman Building is the location of the Arts and Science research groups services.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The V Annex is the location of the Centre 2110 and CUTV services.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'Classes for the Departments of Studio Arts, Creative Art Therapies, Art History and Art Education are located here. You’ll also find the VAV Gallery, a student-run exhibition space.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The K Annex is the location of the Concordia International services',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The Z Annex is the location of the Multi-Faith and Spirituality Centre as well as the Sustainable Concordia services.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The AD and CC Buildings house Health Services, the Loyola College for Diversity and Sustainability, Counselling and Development (for personal, educational and career counselling), the Access Centre for Students with Disabilities and the Multi-Faith and Spirituality Centre.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The CJ Building is where our Communication Studies and Journalism students take classes and make use of media labs, plus video production and editing suites. The Concordia Bookstore is also here.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'The Stinger Dome, an air-supported structure, covers the field from November to April, so Concordians can join a game of soccer or Ultimate all year round.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Loyola Chapel is a beautiful, quiet place available to people of all faiths. Students use the F.C. Smith Auditorium for theatrical productions and workshops. Concerts and other events take place at The Cazalet Theatre.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Research Centre for Structural and Functional Genomics Building is Concordia’s largest multidisciplinary research centre, bringing together biologists, chemists and bioinformaticians.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'Hingston Hall and the Jesuit Residence are home away from home for the hundreds of Concordians who live on campus. Note: This space is not open for campus visitors.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Physical Services Building hosts the Environmental Health and Safety Office as well as the Facilities Management Department.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Psychology building is home to the Department of Psychology and the Centre for Clinical Research in Health',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Quad is an expansive green space where students relax between classes on warm days. Frosh activities, barbecues and outdoor concerts take place here.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Loyola Jesuit Hall and Conference Centre hosts conferences and Concordia conference services.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Loyola Student Center is where the Loyola cafeteria, Campus Centre, Food Services, and student ran café are located.',
    boundaries: [
  ...
  },
  {
    ...
    description:
      'St. Ignatius Church is a Roman Catholic Parish church located on Loyola Campus.',
    boundaries: [
  ...
  },
  {
    ...
    address: '7141 Sherbrooke St W., Montreal, QC H4B 1R6',
    description:
      'The Richard J. Renaud Science Pavilion is the main building for students in biology, chemistry and biochemistry, physics, exercise science and psychology. It also houses the Science College, a specialized learning community dedicated to solving current problems through lab work and research.',
    boundaries: [
